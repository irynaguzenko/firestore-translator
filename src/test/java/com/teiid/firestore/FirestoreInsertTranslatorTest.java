...
public class FirestoreInsertTranslatorTest {
    ...
    public void deleteCreated() {
        String query = "DELETE from CountriesT WHERE test_inserted = true";
        template.update(query);
    }

    @Test
    public void shouldAddDocumentToCollectionWhenInsertingWithoutId() {
        String query = "INSERT INTO CountriesT (country_name, irreligious, test_inserted) VALUES ('WithoutId', 11, true)";
    ...
    public void shouldAddDocumentToCollectionWhenInsertingWithId() {
        String query = "INSERT INTO CountriesT (id, country_name, test_inserted) VALUES ('testId', 'WithId', true)";
        int rowsAffected = template.update(query);
        assertEquals(1, rowsAffected);
    ...
    public void shouldAddDocumentToCollectionWhenItContainsNestedFieldName() {
        String query = "INSERT INTO CountriesT (president_name, test_inserted) VALUES ('Frank-Walter Steinmeier', true)";
        int rowsAffected = template.update(query);
        assertEquals(1, rowsAffected);
    ...
    public void shouldAddMultipleDocumentsToCollectionWhenInsertingWithId() {
        String query = "INSERT INTO CountriesT (id, country_name, test_inserted) VALUES ('A', 'France', true), ('B', 'Greece', true), ('C', 'Finland', true)";
        int rowsAffected = template.update(query);
